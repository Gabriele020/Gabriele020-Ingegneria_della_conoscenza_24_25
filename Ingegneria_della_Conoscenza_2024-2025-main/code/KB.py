...
# Inizio KB
# Lettura csv
movieDataString = pd.read_csv(r"Ingegneria_della_Conoscenza_2024-2025-main\datasets\Netflix_preprocessato.csv", sep=',')
...
def askGenereDaTitolo(titolo:str,genere:str):
    ...
    rispostaUtente=input("Vuoi la spiegazione? Digitare yes se vuoi saperne di più: ")
    if (rispostaUtente.lower()=="yes"):
...
def askStessoGenere(titolo1:str, titolo2:str):
    ...
    if (rispostaUtente.lower()=="yes"):
       ...
       rispostaUtente=input("Scrivere quale delle tre corrispondenze separate da <=> si vuole approfondire: 1 , 2 o 3: ")
       if(rispostaUtente.lower()=='1'):
           print(titolo1+"_"+primoGenere+" <=>", risposte.get(1))
           rispostaUtente=input("Scrivere quale delle tre corrispondenze separate da <=> si vuole approfondire: 1 , 2 o 3: ")
           if(rispostaUtente.lower() =="2"):
