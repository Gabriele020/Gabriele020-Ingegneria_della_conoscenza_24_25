...
def main():
    ...
    movieData1 = pd.read_csv(r'Ingegneria_della_Conoscenza_2024-2025-main\datasets\Netflix_serie_film.csv', sep=',')
    movieData2 = pd.read_csv(r'Ingegneria_della_Conoscenza_2024-2025-main\datasets\Netflix_film.csv', sep=',')
    movieRatings = pd.read_csv(r'Ingegneria_della_Conoscenza_2024-2025-main\datasets\IMDb_valutazioni.csv', sep=',')
    ...
    df.to_csv(r'Ingegneria_della_Conoscenza_2024-2025-main\datasets\Netflix_preprocessato.csv', index = False)
    return df
