...
def finalClassification(X,y):
    ...
    clf.fit(X,y) 
    #salvataggio modello
    filename =r'Ingegneria_della_Conoscenza_2024-2025-main\code\finalized_rf.sav'
...
def main(userMovie):
    ...
    df = pd.read_csv(r'Ingegneria_della_Conoscenza_2024-2025-main\datasets\Netflix_preprocessato.csv', sep=',')
